...
/*
    ...
    localhost:5000/count?service=Location
    localhost:5000/Summary
    localhost:5000/Structure
    localhost:5000/factorized
    localhost:5000/PieChart?service=Company
    localhost:5000/BarChart?service=Title
    localhost:5000/BarChart?service=Location
*/
